...
public class RobotContainer {
    ...
    public RobotContainer() throws Exception {
        ...
        NamedCommands.registerCommand("hubTrack", new InstantCommand(drivebase::enableHubTracking));
        NamedCommands.registerCommand("stopHubTrack", new InstantCommand(drivebase::disableHubTracking));
